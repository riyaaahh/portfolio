          ...
          <div className='flex gap-3'>
            <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                <div className=''>
                    ...
                    <p class="mt-2 text-sm text-green-500">edward412@gmail.com</p>
                </div>
            ...
            <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                <div className=''>
                    ...
                    <p class="mt-2 text-sm text-green-500">@edwarddev._</p>
                </div>
                ...
                <div className=''>
                    ...
                    <p class="mt-2 text-sm text-green-500">@edwarddev 
</p>
                </div>
                ...
                <div className=''>
                    ...
                    <p class="mt-2 text-sm text-green-500">linkedin.com/in/edwarddev</p>
                </div>
            </div>
            </div>
