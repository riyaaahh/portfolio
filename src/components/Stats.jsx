...
const Stats = () => {
  ...
  return (
    <div className="bg-white pb-14 border-y-2 border-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-16 mb-10">
        <h2 className="text-3xl font-extrabold text-gray-900 mb-6">Website Statistics</h2>
        <div className="flex justify-center space-x-8">
          ...
          <h3 className="text-3xl font-bold text-green-600"  id="otherStatistic">{stats.otherStatistic}+</h3>
            <p className="text-gray-600">Sponsorship</p>
          </div>
        </div>
      </div>
    </div>
